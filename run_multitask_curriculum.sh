domain=MiniGrid
env1=PickupKey-v0,OpenDoor-v0 #Empty-8x8-v0 #UnlockPickup-v0 # highway-v0 # Breakout-v5
env2=Unlock-v0,BlockedOpenDoor-v0
env3=Pickup-v0,BlockedPickup-v0,UnlockPickup-v0,BlockedUnlock-v0
env4=UnlockPickup-v0,BlockedUnlockPickup-v0
env5=BlockedUnlockPickup-v0
...
#        echo "Pre Training for seed $seed in env $env4"
